...
-----------------------------------------------------------------
./src/test/java/com.mulesoft.training.dataweave.examples/dataweavenumberformats/DataweavenumberformatsTestCase.java
...
-----------------------------------------------------------------
./src/test/resources/dataweavenumberformats-functional-test-config.xml

Defines the Mule configuration for the DataweavenumberformatsTestCase.java.
...
artifactId=dataweavenumberformats
description=Demonstrates DataWeave number formats and conversions
muleVersion=3.8.3
packagePath=com/mulesoft/training
forgeProject=n
transports=vm,http
modules=client,cxf,management,scripting,sxc,xml

version=1.0-SNAPSHOT
groupId=com.mulesoft.training.dataweave.examples
basedir=/Users/ethan.port/dataweave/dataweave-number-format
--------------------------------------------------------------------